...
```{r fig.cap="**Fig X.** Visualización de la función Rosenbrock f(x1,x2) (3D)", fig.align="center", out.width="70%", layout.align="center",echo=FALSE}
...
```{r fig.cap="**Fig X.** _Mapa de Calor Función Rosenbrock_", fig.align="center", out.width="70%",echo=FALSE, message=FALSE}
