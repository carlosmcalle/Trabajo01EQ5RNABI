...
```{r fig_ga_2d, fig.cap="**Fig X.** Animación Algoritmos evolutivos 2D", fig.align="center", out.width="70%"}
...
```{r fig_ga_3d, fig.cap="**Fig X.** Animación Algoritmos evolutivos 3D", fig.align="center", out.width="70%"}
...
```{r fig_pso_2d, fig.cap="**Fig X.** Animación Optimización de particulas 2D", fig.align="center", out.width="70%"}
...
```{r fig.cap="**Fig 8.** Visualización de la función Rosenbrock f(x1,x2) (3D)", fig.align="center", out.width="70%", layout.align="center",echo=FALSE}
...
```{r fig.cap="**Fig 9.** _Mapa de Calor Función Rosenbrock_", fig.align="center", out.width="70%",echo=FALSE, message=FALSE, warning=FALSE}
...
```{r resultado_optimizacion_2d,fig.cap="**Tabla X.** _Resultados de la Optimizació de Rosenbrock f(x1,x2) _", fig.align="center", out.width="70%", echo=FALSE}
...
```{r resultado_optimizacion_3d,fig.cap="**Tabla X.** _Resultados de la Optimizació de Rosenbrock f(x1,x2,x3) _", fig.align="center", out.width="70%", echo=FALSE}
...
```{r fig_dg_2d, fig.cap="**Fig X.** Animación Descenso del gradiente 2D", fig.align="center", out.width="70%"}
...
```{r fig_ed_2d, fig.cap="**Fig X.** Animación Evolución Diferencial 2D", fig.align="center", out.width="70%"}
...
```{r gifrosenga, fig.cap="**Fig X.** Animación Algoritmos Evolutivos 2D", fig.align="center", out.width="70%"}
...
```{r gifrosenga, fig.cap="**Fig X.** Animación Optimización PSO 2D", fig.align="center", out.width="70%"}
...
-   Juan Camilo Valencia: optimización combinatoria colonia de hormigas (algoritmo y gráficos)

-   David Castro: optimización por descenso del gradiente y algoritmos evolutivos de Rosenbrock
